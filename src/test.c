...
struct testcase_t testcases[] = {
	{"",				 0,	HASHIDS_DEFAULT_ALPHABET,							  1, {1ull},															 "jR",					   __LINE__},
	{"",				 0,	HASHIDS_DEFAULT_ALPHABET,							  1, {12345ull},														 "j0gW",					 __LINE__},
	{"",				 0,	HASHIDS_DEFAULT_ALPHABET,							  1, {22ull},															"Lw",						__LINE__},
	{"",				 0,	HASHIDS_DEFAULT_ALPHABET,							  1, {333ull},														   "Z0E",					  __LINE__},
	{"",				 0,	HASHIDS_DEFAULT_ALPHABET,							  1, {9999ull},														  "w0rR",					__LINE__},
	{"",
		0,					  HASHIDS_DEFAULT_ALPHABET,
		1,																			   {18446744073709551615ull},
		"AOo9Ql5nQR1VO",																																							   __LINE__},
	{"",
		0,					  HASHIDS_DEFAULT_ALPHABET,
		4,																			   {683ull, 94108ull, 123ull, 5ull},
		"vJvi7On9cXGtD",																																							   __LINE__},
	{"",				 0,	HASHIDS_DEFAULT_ALPHABET,							  3, {1ull, 2ull, 3ull},												 "o2fXhV",				   __LINE__},
	{"",				 0,	HASHIDS_DEFAULT_ALPHABET,							  3, {2ull, 4ull, 6ull},												 "xGhmsW",				   __LINE__},
	{"",				 0,	HASHIDS_DEFAULT_ALPHABET,							  2, {99ull, 25ull},													 "3lKfD",				  __LINE__},

	{"Arbitrary string",
		0,					  HASHIDS_DEFAULT_ALPHABET,
		4,																			   {683ull, 94108ull, 123ull, 5ull},
		"QWyf8yboH7KT2",																																							   __LINE__},
	{"Arbitrary string",
		0,					  HASHIDS_DEFAULT_ALPHABET,
		3,																			   {1ull, 2ull, 3ull},
		"neHrCa",																																									  __LINE__},
	...
	{"",
		...
		3,																			   {7452ull, 2967ull, 21401ull},
		"pO3K69b86jzc6krI416enr2B5",																																				   __LINE__},
	{"",
		25,					 HASHIDS_DEFAULT_ALPHABET,
		3,																			   {1ull, 2ull, 3ull},
		"gyOwl4B97bo2fXhVaDR0Znjrq",																																				   __LINE__},
	{"",
		25,					 HASHIDS_DEFAULT_ALPHABET,
		1,																			   {6097ull},
		"Nz7x3VXyMYerRmWeOBQn6LlRG",																																				   __LINE__},
	{"",
		25,					 HASHIDS_DEFAULT_ALPHABET,
		2,																			   {99ull, 25ull},
		"k91nqP3RBe3lKfDaLJrvy8XjV",																																				   __LINE__},

	{"arbitrary salt",
		16,					 "abcdefghijklmnopqrstuvwxyz",
		3,																			   {7452ull, 2967ull, 21401ull},
		"wygqxeunkatjgkrw",																																							__LINE__},
	{"arbitrary salt",
		16,					 "abcdefghijklmnopqrstuvwxyz",
		3,																			   {1ull, 2ull, 3ull},
		"pnovxlaxuriowydb",																																							__LINE__},
	{"arbitrary salt",
		16,					 "abcdefghijklmnopqrstuvwxyz",
		1,																			   {60125ull},
		"jkbgxljrjxmlaonp",																																							__LINE__},
	{"arbitrary salt",
		16,					 "abcdefghijklmnopqrstuvwxyz",
		2,																			   {99ull, 25ull},
		"erdjpwrgouoxlvbx",																																							__LINE__},

	{"",
		0,					  "abdegjklmnopqrvwxyzABDEGJKLMNOPQRVWXYZ1234567890",
		3,																			   {7452ull, 2967ull, 21401ull},
		"X50Yg6VPoAO4",																																								__LINE__},
	{"",
		0,					  "abdegjklmnopqrvwxyzABDEGJKLMNOPQRVWXYZ1234567890",
		3,																			   {1ull, 2ull, 3ull},
		"GAbDdR",																																									  __LINE__},
	...
	{"this is my salt",	0,  HASHIDS_DEFAULT_ALPHABET,							 1, {1ull},																"NV",					  __LINE__},
	{"this is my salt",	0,  HASHIDS_DEFAULT_ALPHABET,							 1, {22ull},															 "K4",					   __LINE__},
	{"this is my salt",	0,  HASHIDS_DEFAULT_ALPHABET,							 1, {333ull},															  "OqM",					 __LINE__},
	{"this is my salt",	0,  HASHIDS_DEFAULT_ALPHABET,							 1, {9999ull},														   "kQVg",				   __LINE__},
	{"this is my salt",	0,  HASHIDS_DEFAULT_ALPHABET,							 1, {9999ull},														   "kQVg",				   __LINE__},
	{"this is my salt",	0,  HASHIDS_DEFAULT_ALPHABET,							 1, {12345ull},															"NkK9",					__LINE__},
	{"this is my salt",	0,  HASHIDS_DEFAULT_ALPHABET,							 1, {123000ull},														 "58LzD",				  __LINE__},
	{"this is my salt",
		0,					  HASHIDS_DEFAULT_ALPHABET,
		1,																			   {456000000ull},
		"5gn6mQP",																																									 __LINE__},
	...
	{"this is my salt",
		0,					  HASHIDS_DEFAULT_ALPHABET,
		1,																			   {666555444333222ull},
		"KVO9yy1oO5j",																																								 __LINE__},
	{"this is my salt",
		0,					  HASHIDS_DEFAULT_ALPHABET,
		1,																			   {18446744073709551615ull},
		"zXVjmzBamYlqX",																																							   __LINE__},

	{"this is my salt",
		0,					  HASHIDS_DEFAULT_ALPHABET,
		5,																			   {1ull, 2ull, 3ull, 4ull, 5ull},
		"zoHWuNhktp",																																								  __LINE__},
	{"this is my salt",
		0,					  HASHIDS_DEFAULT_ALPHABET,
		3,																			   {1ull, 2ull, 3ull},
	...
	{"this is my salt",
		0,					  HASHIDS_DEFAULT_ALPHABET,
		3,																			   {1337ull, 42ull, 314ull},
		"7xKhrUxm",																																									__LINE__},
	{"this is my salt",
		0,					  HASHIDS_DEFAULT_ALPHABET,
		4,																			   {683ull, 94108ull, 123ull, 5ull},
		"aBMswoO2UB3Sj",																																							   __LINE__},
	{"this is my salt",
		0,					  HASHIDS_DEFAULT_ALPHABET,
	...
	{"this is my salt",
		18,					 HASHIDS_DEFAULT_ALPHABET,
		1,																			   {1},
		"aJEDngB0NV05ev1WwP",																																						  __LINE__},
	{"this is my salt",
		18,					 HASHIDS_DEFAULT_ALPHABET,
	...
	{"this is my salt",	0,  "cfhistuCFHISTU+-",								   1, {1337ull},															 "+-+-++---++-",			 __LINE__},

	{"this is my salt",
		0,					  "abdegjkomnopqrvwxyzABDEGJKLMNOPQRVWXYZ1234567890"
		"!@#$%^&*()-_=+;:,.<>/?`~[]{}",									 1,
		{1ull},
		"V7",																																										  __LINE__},

	{"",				 22, "abdegjk0123456789",								  1, {190126ull},														"070683k2j3771430j49157", __LINE__},
	{"\\7ULC'",
		22,					 "@'l*p9n]);+7>Ar(\\",
		1,																			   {190126ull},
		"9];r(An97\\]]\\()>7>\\)+]",																																				   __LINE__},
...
int main(int argc, char **argv) {
	...
	for(;; ++i, ++j) {
		...
		/* bail out */
		if(!testcase.salt || !testcase.alphabet || !testcase.expected_hash) { break; }

		/* initialize hashids */
		hashids =
			hashids_init3(testcase.salt, testcase.min_hash_length, testcase.alphabet);
		...
		if(!buffer) {
			fail		  = 1;
			failures[k++] = f("%s:%d: cannot allocate buffer", __FILE__, testcase.line);
			goto test_end;
		}

		/* encode */
		result =
			hashids_encode(hashids, buffer, testcase.numbers_count, testcase.numbers);
		...
		if(memcmp(numbers, testcase.numbers, result * sizeof(unsigned long long))) {
			fail = 1;
			failures[k++] =
				f("%s:%d: hashids_decode() decoding error", __FILE__, testcase.line);
			goto test_end; /* nop? */
		}
	...
	test_end:
		...
		if(fail && fail_fast) {
			...
			for(i = 0; i < testcase.numbers_count; ++i) {
				...
				if(i < testcase.numbers_count - 1) { fputs(" ", stdout); }
			}
			fputs("\n", stdout);
